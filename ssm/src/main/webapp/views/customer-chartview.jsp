...
<header style="height: 50px;background-color: #c0dafb;">
  ...
  <div class="logo_right_box">
    <ul class="logo_right_left">
      ...
      <li><a class="chartview" href="customer - chartview.html"><span style="padding: 12px; color: #58a0fd">图表查看</span></a></li>
...
<iframe src="person_chartView.jsp" id="mainiframe" width="100%" height="100%"  frameborder="no" border="0" scrolling="no"></iframe>
</body>
</html>
