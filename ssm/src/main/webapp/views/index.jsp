...
<style type="text/css">
    #mainiframe{max-height:5000px;}
</style>
<body>
<div class="top"></div>
<div class="hea">中国农产品真菌毒素及产毒真菌污染数据库 </div>
<div class="titl"><span class="logo"></span>
 ...
 <a class="gr public" href="javascript:;">数据浏览</a> <a href="javascript:if(confirm('确实要退出吗?'))location='Quit'" class="quit">退出</a><span class="usename">欢迎您：&nbsp;&nbsp;用户名!</span></div>

<iframe src="QueryAll" id="mainiframe" width="100%" frameborder="no" border="0" scrolling="no" height="100%"></iframe>
...
<script type="text/javascript">
   var oLi=$('.public').length;
    ...
    var arr=[
        './QueryAll',
        './views/IM.jsp',
        './views/superadmin.jsp',
        '<%=basePath%>QueryaboutcropCategory',
        ]
    for(let i=0;i<oLi;i++){
