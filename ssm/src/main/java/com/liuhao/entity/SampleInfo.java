...
public class SampleInfo {
    ...
    private List<SampleToxin> infos;

    private BacterialStrainInfo bacterialStrainInfo;
	...
	public BacterialStrainInfo getBacterialStrainInfo() {
		return bacterialStrainInfo;
	}

	public void setBacterialStrainInfo(BacterialStrainInfo bacterialStrainInfo) {
		this.bacterialStrainInfo = bacterialStrainInfo;
	}
	...
	public List<SampleToxin> getInfos() {
		return infos;
	}

	public void setInfos(List<SampleToxin> infos) {
		this.infos = infos;
	}
